                  ...
                  itemBuilder: (c, index) => Card(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.stretch,
                        children: [
                          Text("# " + controller.pendingBookingOrder[index].ordersId.toString(), style: Get.textTheme.bodyText1),
                          Row(
                            children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                ...
                                // controller.pendingBookingOrder[index].skillId.toString(),
                                style: Get.textTheme.bodyText1!.copyWith(fontWeight: FontWeight.bold),
                              )
                            ],
                          ),
                          ...
                          Gutter(scale: 0.5),
                          Text((controller.pendingBookingOrder[index].note).toString(), style: Get.textTheme.bodyText1!.copyWith(color: Colors.grey)),
                          Divider(thickness: 1),
                          Row(
                            children: [
                              Expanded(
